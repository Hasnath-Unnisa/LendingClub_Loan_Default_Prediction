...
| State (`addr_state`) | NV (21.7%), AK (18.7%), FL (17.6%) | Regional differences highlight localized risks. |
...
Both models were trained on the preprocessed dataset, with a train-test split evaluation.
...
git clone https://github.com/Hasnath-Unnisa/LendingClub_Loan_Default_Prediction.git
